...
INSERT INTO public.data_table (column_1,
  column_2,
  column_3, 
  join_id)
VALUES
...
CREATE TABLE public.email_table (
join_id int, 
email string);
INSERT INTO public.email_table (join_id,
email)
VALUES
...
SELECT db.join_id 
FROM public.data_table db
JOIN public.email_table wh ON db.join_id = wh.join_id
WHERE db.column_1 % 2 = 0
  AND db.column_2 < db.column_1
  AND db.column_3 % 10 = 1;
